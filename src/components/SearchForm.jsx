 ...
 return(
  <div>
    <form onSubmit={handleSubmit} className='flex gap-2'>
      ...
      />
      <button type='submit' className='border border-blue-600 bg-blue-400 hover:bg-blue-500 text-white ml-[-29%] px-6 my-2 py-2 rounded-full text-lg font-semibold'>Search</button>
        </div>
